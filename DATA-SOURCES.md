...
| `data/ffd_report.pdf` | Nepal DHM / Flood Forecasting Division press release, 27 Aug 2026 | Government press release, publicly issued | Primary source for the ~20 Mm³ "excess water" figure. Scanned Nepali, no text layer — **transcribed and translated in full in `research/ffd-press-release-27aug.md`** (8 Sept 2026), which is what to read and cite. Retained because official PDFs are frequently withdrawn or moved; **link to the original in preference to redistributing** if the repo goes public. |
